...
assetRackWisetHistorySelectQuery = """select * from asset_assetracktracking  where tagid_id=%s  order by id desc limit 1"""
# insertAssetTrckingQuery = """ insert into asset_assettracking"""
assetRackWiseHistoryInsertQuery = """ insert into asset_assetracktracking(starttime,endtime, tagid_id,rack_id) values(%s,%s,%s,%s)"""
assetRackWiseHistoryUpdateQuery = """ update asset_assetracktracking set endtime=%s where id=%s"""


alertAssetSelectQuery = """select * from alert_assetalert  where macid_id=%s order by id desc limit 1"""
alertAssetInsertQuery = """ insert into alert_assetalert(lastseen,macid_id, placedIn_id,removedFrom_id) values(%s, %s, %s, %s)"""
...
updateTempAlertQuery = """update alert_alert set lastseen=%s where id=%s"""
